                ...
                <div className="lg:relative">
                    ...
                    <span className="lg:absolute lg:bottom-40 lg:left-80">
                        ...
                        <div className="lg:inline-block bg-white rounded-2xl p-5 shadow-sm">
                            <p className="text-base font-normal text-center text-darkgray">A professional, fast, and creative team. <br /> They hit the mark with SEO and advertising campaigns! </p>
                            <h3 className="text-2xl font-medium text-center py-2">Jony Scotty</h3>
                            <h4 className="text-sm font-normal text-center">Telemedicine / Online Healthcare</h4>
                        </div>
                    </span>
